...
menuItem4 = MenuItem(
    ...
    and seasoned with a spicy mix(chilli, tamarind among others) and slow 
    cooked in a cylindrical clay or
    metal oven which gets its 
...
menuItem1 = MenuItem(
    ...
    Beans, Avocado, Cilantro, Salsa, 
    Tortilla""", price="$5.95", course="Entree", 
    restaurant=restaurant1)
