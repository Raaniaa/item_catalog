...
menuItem2 = MenuItem(
    ...
    description=" A famous duck dish hat has been prepared since the imperial era.", 
...
menuItem6 = MenuItem(
    user_id=1, 
    name="Ramen", 
    description="a Japanese noodle soup dish consists of Chinese-style wheat noodles served a meat",
    price="12", course="Entree", restaurant=restaurant2)
...
menuItem1 = MenuItem(
    user_id=1, name="Pho", 
    description="a Vietnamese noodle soup consisting of broth linguine-shaped rice noodles called banh pho",
...
menuItem2 = MenuItem(
    ...
    description="a common Chinese dumpling which of minced meat and chopped vegetables wrapped into a piece of dough skin",
...
menuItem1 = MenuItem(
    ...
    description="Rich, luscious sponge cake soaked in weet milk and topped with vanilla.",
...
menuItem4 = MenuItem(
    ...
    description="Golden fried cauliflower florets in a midly spiced soya, garlic sauce cooked with fresh cilantro.",
...
menuItem5 = MenuItem(
    ...
    description="Vegan goodness. Burrito filled with rice, garbanzo beans, curry sauce, potatoes(aloo)",
...
menuItem1 = MenuItem(
    user_id=1, 
    name="Lamb Curry", 
    description="Slow cook that thang in a pool of tomatoes nions and alllll those tasty Indian spices",
    price="$9.95", course="Entree", restaurant=restaurant1)
...
menuItem9 = MenuItem(
    ...
    description="Fresh battered sirloin steal fried and smothered with cream gravy",
...
menuItem1 = MenuItem(
    ...
    description="Marinated Pork, Rice,Beans, Avocado, Cilantro, Salsa.", price="$5.95", course="Entree", 
    restaurant=restaurant1)
